export default [
    ...
    { label: 'From', name: 'from', noValueError: 'You must provide a FROM email address' },
    { label: 'Recipient List', name: 'recipients', noValueError: 'You must provide an email address' }
];